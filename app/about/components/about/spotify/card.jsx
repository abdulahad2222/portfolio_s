	...
	return (
		<div className="mt-3 flex justify-center w-full">
			{loading ? (
				...
				<div className="relative w-full mb-8 grid grid-cols-2  gap-2 border-2 border-gray-500 p-4 rounded-lg backdrop-filter backdrop-blur-lg dark:bg-black bg-white bg-opacity-30">
					{result.isPlaying && (
					<Image
					...
					<div className="z-10  flex items-center">
						<FontAwesomeIcon
							icon={faSpotify}
							className="dark:text-white text-black text-5xl me-5 md:me-1 xl:me-8"
						/>
